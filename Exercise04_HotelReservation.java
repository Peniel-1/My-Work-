...
public class Exercise04_HotelReservation {
    ...
    public double calculateStayTotal(int numberOfNights) {
        if (numberOfNights < 3)
            return numberOfNights * this.DAILY_RATE;
        else
            return numberOfNights * this.DISCOUNT_RATE;
    }
    ...
    public double calculateStayTotal(int numOfTotalNights, int numOfWeekendNights, boolean isRewardsMember) {
        ...
        if (isRewardsMember)
            return numOfTotalNights * this.DISCOUNT_RATE;
        else
            return this.calculateStayTotal(numOfTotalNights, numOfWeekendNights);
